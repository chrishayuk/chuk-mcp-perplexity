    ...
    if not api_key:
        ...
        try:
            ...
            if api_key_after_reload:
                print(f"✅ Found API key after reload!")
        ...
        if api_key.startswith('pplx-'):
            print(f"✅ PERPLEXITY_API_KEY found and has correct format (pplx-...)")
            print(f"   Key length: {len(api_key)} characters")
        else:
            print(f"⚠️  PERPLEXITY_API_KEY found but may have incorrect format")
            print(f"   Expected: pplx-... format")
